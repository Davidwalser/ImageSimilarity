...
\begin{figure}[htbp]
	\centering
		\includegraphics[height=9cm]{images/negative_pairs.png}
...
Zu Beginn der Datenanalyse ist Aufgefallen dass es häufig der Fall ist, dass sich ähnliche Bilder in der Ordnerstruktur direkt nebeneinander befinden (siehe Abbildung rot markiert \ref{fig:data_positive_pair}).
\begin{figure}[htbp]
	\centering
		\includegraphics[height=4cm]{images/data_positive_pair.png}
...
Mithilfe der gewonnen Erkentniss zum SIFT Algorithmus und der Datenanalyse wurde eine Hilfsfunktion geschrieben, mit der positive Paare generiert werden können.
