...
\begin{enumerate}
	...
	\item Die beiden Klasifizierer trainieren sich gegenseitig mit den pseudo-labels und es wird das höchste Konfidenzniveau angestrebt. Wenn z.B. der erste Klassifizierer das Label für einen Datensatz vorhersagt, während der andere einen Fehler macht, so werden die vom ersten Klassifizierer zugewiesenen pseudo-labels die vom zweiten überschreiben und vice-versa. \cite{semisupervisedalexsoft}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	\centering
		\includegraphics[height=5cm]{images/reinforcement.png}
...
Im Gegensatz zu supervised oder unsupervised learning werden beim Reingforcement Learning vorab keine Daten benötigt.
