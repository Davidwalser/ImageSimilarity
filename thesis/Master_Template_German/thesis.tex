...
\subsubsection{Architektur Siamese Network}
...
Vergleich SIFT vs. CNN. vs. Simaese Network
SIFT: benötigt keine Trainignsdaten + keine Bildvorverarbeitung
traditionelles CNN: benötigt Trainingsdaten, benötigt Bildvorverarbeitung
Siamese Network (mit CNN): benötigt nur wenige Daten um zu lernen, benötigt Bildvorverarbeitung
