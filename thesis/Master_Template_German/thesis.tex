...
Die Matches befinden sich in diesem Fall hauptsächlich im Textbereich, wobei sich auch bei der Figur welche befinden.
In Abbildung \ref{fig:sift_match_bad} sind die Keypoints und Matches zwischen dem Testbild und einem nicht ähnlichen Bild dargestellt und es ist zu sehen dass hier deutlich weniger Matches gefunden wurden.
\begin{figure}[htbp]
	\centering
		\includegraphics[height=8.2cm]{images/sift_match_good.png}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[height=7.8cm]{images/sift_match_bad.png}
